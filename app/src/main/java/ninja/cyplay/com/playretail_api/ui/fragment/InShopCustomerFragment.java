...
import ninja.cyplay.com.playretail_api.ui.adapter.HomeInShopCustomerRecyclerAdapter;
import ninja.cyplay.com.playretail_api.ui.listener.RecyclerItemClickListener;

/**
 * Created by damien on 30/04/15.
 */
public class InShopCustomerFragment extends BaseFragment {

    @Inject
    SellerContext sellerContext;

    @InjectView(R.id.no_customer_text)
    TextView noCustomerText;

    @InjectView(R.id.recycler_view)
    RecyclerView recyclerView;

    private HomeInShopCustomerRecyclerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_in_shop_customer, container, false);
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        adapter = new HomeInShopCustomerRecyclerAdapter(sellerContext.getCustomer_history());
    }
