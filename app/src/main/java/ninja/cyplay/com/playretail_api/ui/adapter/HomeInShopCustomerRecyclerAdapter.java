 ...
 */
public class HomeInShopCustomerRecyclerAdapter extends RecyclerView.Adapter<CustomerHistoryViewHolder> {

    private List<CustomerPreview> customers;

    public HomeInShopCustomerRecyclerAdapter(List<CustomerPreview> customers) {
    ...
    public void onBindViewHolder(CustomerHistoryViewHolder holder, int position) {
        ...
        holder.inHouse.setVisibility(View.VISIBLE);
    }
