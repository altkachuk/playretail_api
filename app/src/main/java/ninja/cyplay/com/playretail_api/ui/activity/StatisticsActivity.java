...
public class StatisticsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.activity_statistics, null);
        setContentView(view);
        ...
        statisticsFragment = (StatisticsFragment) getSupportFragmentManager().findFragmentById(R.id.fragment);
    }
